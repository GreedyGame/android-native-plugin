...
This is a complete guide to integrate GreedyGame plugin within your native android game. You can download [GreedyGameAgent_v6.9.4jar](current-sdk/GreedyGameAgent_v6.9.4jar).
